...
@section('container')
    <main>
        <div class="content p-0 mt-5 mb-5">
            <div class="judul fw-bold fs-1">Mading Competition</div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                <img src="../../img/poster-lomba/Slice 6.png" alt="">
                            </div>
                        </div>
                            ...
                            <div class="row px-1">
                                ...
                                <div class="row g-0">
                                    <div class="col-12 px-3 py-1 mt-0">
                                        ...
                                        data-aos-offset="300"
                                        data-aos-duration="1000">
                                            Madding competition diperuntukkan bagi siwa/I sma sedersjat untuk membentuk sebuah madding 3 dimensi dan bagi siswa/I smp sederajat membuat madding 2 dimensi dengan kreatifitasyang mampu memaparkan seluk-beluk ilmu fisika melalui sentuhan seni dengan tema yang ditentukan.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 px-3 py-1">
                                        ...
                                        data-aos-duration="1000">
                                            ...
                                            <ul>
                                                <li>Siswa smp/sederajat dan siswa sma/sederajat se indonesia </li>
                                                ...
                                                <li>Mading disesuaikan dengan tema yang telah ditentukan.</li>
                                                <li>Madding yang dibuat adalah dalam bentuk 3D</li>
                                                <li>Perlengkapan mading yang menggunakan cat dan potong memotong disiapkan dirumah.</li>
                                                <li>Mading dirangkai pada saat perlombaan berlangsung, peserta tidak diperkenankan merangkai mading diluar perlombaan.</li>
                                                <li>Peserta wajib mematuhui segala peraturan lomba.</li>
                                                <li>Bagi peserta yang terlambat mengikuti lomba tidak ada tambahan waktu.</li>
                                                <li>Waktu yang diberikan pada saat perlomba adalah 120 menit</li>
                                                <li>Hasil karya jadi hak milik panitia.</li>
