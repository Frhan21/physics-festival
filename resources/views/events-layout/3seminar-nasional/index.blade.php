...
<head>
    <title>Seminar Nasional - PFXXIV</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="col-12 col-lg-10">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                <img src="../../img/poster-lomba/Slice 1.png" alt="Lomba Fisika">
                            </div>
                        </div>
                                ...
                                <div class="row g-0">
                                    <div class="col-12 px-3 mt-0">
                                        <div class="detail p-5">
                                           <br>
                                            Merupakan sebuah kegiatan berbagi ilmu oleh pemateri yang terkenal dengan berbagai manfaat yang didapatkan. Seminar Nasional diikuti oleh pelajar dan umum dengan tema "Radioterapi".
                                            <br>
                                            <br>
