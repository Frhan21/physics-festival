...
@section('container')
    <main>
        <div class="content p-0 mt-5 mb-5">
            <div class="judul fw-bold fs-1">Design Competition</div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                <img src="../../img/poster-lomba/Slice 5.png" alt="">
                            </div>
                        </div>
                            ...
                            <div class="row px-1">
                                    ...
                                    <div class="col-6 col-lg-6 pb-1 pt-0 ps-3 pe-1">
                                        ...
                                        data-aos-duration="1000">
                                            ...
                                            <div class="d-flex flex-column ps-3">
                                                ...
                                                <div class="sub">
                                                    20 November 2022 - 29 Januari 2023
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-0">
                                    <div class="col-12 px-3 py-1 mt-0">
                                        ...
                                        data-aos-offset="300"
                                        data-aos-duration="1000">
                                            Design competition terdiri dari lomba karikatur dan poster, lomba ini diikuti oleh pelajar, mahasiswwa, dan umum. Melalui lomba ini diharapkan dapat meningkatkan kreatifitas dan bakat pesera dalam design.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 px-3 py-1">
                                        ...
                                        data-aos-duration="1000">
                                            ...
                                            <ul>
                                                ...
                                                <li>Insert pendaftaran: Rp 10.000 (169201003109508 a.n. Chairul Nisa Syaputri)</li>
                                                ...
                                                <li>Bagi peserta yang tidak jadi mengikuti lomba, uang pendaftaran tidak bisa dikembalikan.</li>
                                                <li>Desaign Competition terdiri atas dua cabang lomba yaitu KARIKATUR dan POSTER</li>
                                                <li>Karya peserta dikirim dalam bentuk softcopy ke email panitia <a  href="https://mail.google.com/mail/u/6/#inbox?compose=GTvVlcSHxTqXQQtTzwJbnJJWvzzMZRRSLVhGdvpqxQQMPHDlTvSTgkHMtgFQQZSCsTptZpmDmvLzg" target="_blank">physicsfestivalunand@gmail.com</a> atau harcopy  ke sekretariatan Physics Festival Himafi Unand, Kampus Limau Manis Padang, dengan ukuran karya A3</li>
                                                <li>Karikatur dan poster yang diperlombakan harus sesuai dengan tema yang telah ditentukan.</li>
                                                <li>Hasil karya peserta yang dikirim dalam bentuk hardcopy akan ditampilkan di auditorium unand pada acara pembukaan dan penutupan.</li>
                                                <li>Karya tidak boleh mengandung unsur sara</li>
                                                <li>Tanggal pengiriman karya 20 November 2022-29 Januari 2023</li>
                                                <li>Untuk poster boleh menggunakan aplikasi design,  dan karikatur boleh berwarna atau tidak.</li>
                                                <li>Kategori pemenang terdiri dari poster dan karikatur terbaik, dan design terfavorit.</li>
                                                <li>Pemenang kategori design terfavorit hanya berlaku untuk karya yang dikirim dalam bentuk hardcopy.</li>
                                                <li>Pengumuman pememang disampaikan pada hari penutupan.</li>
                                                <li>Keputusan dewan juri tidak dapat diganggu gugat.</li>

                                            </ul><br>
                                            <a name="" id="" class="btn btn-primary" href="{{ route('dashboard') }}" role="button">Daftar sekarang!</a>
