...
@section('container')
    ...
    <main>
        <div class="content p-0 mt-5 mb-5">
            <div class="judul fw-bold fs-1">Ranking 1</div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                <img src="../../img/poster-lomba/Slice 7.png" alt="">
                            </div>
                        </div>
                            ...
                            <div class="row px-1">
                                ...
                                <div class="row g-0">
                                    <div class="col-12 px-3 py-1 mt-0">
                                        ...
                                        data-aos-offset="300"
                                        data-aos-duration="1000">
                                            Rangking 1 merupakan ajang kecerdasan dari siswa/I SMP dan SMA sederajat dalam mengetahui seputar ilmu pengetahuan alam, khususnya engenai ilmu fisika. Disini siswa dituntut untuk bisa menjawab soal yang diberikan panitia. Kegiatan ini diikuti oleh 100 orang siswa smp dan sma sederajat.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 px-3 py-1">
                                        ...
                                        data-aos-duration="1000">
                                            ...
                                            <ul>
                                                ...
                                                <li>Insert pendaftaran: Rp 15.000</li>
                                                ...
                                                <li>Peserta dilarang mengaktifkan alat komunikasi saat lomba</li>
                                                <li>Kwitansi atau struk pembayaran asli tidak boleh hilang dan harus dibawa saat registrasi lomba</li>
                                                <li>Kwitansi atau struk pembayaran asli tidak boleh hilang dan harus dibawa saat registrasi lomba</li>
                                                <li>Lomba hanya terdiri dari satu babak</li>
